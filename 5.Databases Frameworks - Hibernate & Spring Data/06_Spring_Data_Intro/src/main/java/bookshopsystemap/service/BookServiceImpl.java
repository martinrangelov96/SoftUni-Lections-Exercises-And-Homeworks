...
import bookshopsystemap.domain.entities.*;
import bookshopsystemap.repository.AuthorRepository;
import bookshopsystemap.repository.BookRepository;
...
public class BookServiceImpl implements BookService {
    ...
    private final static String BOOKS_FILE_PATH = "D:\\Programming stuff\\IdeaProjects\\06_Spring_Data_Intro\\src\\main\\resources\\files\\books.txt";
    ...
    public void seedBooks() throws IOException {
        ...
        for (String line : booksFileContent) {
            ...
            EditionType editionType
                    = EditionType.values()[Integer.parseInt(lineParams[0])];
            ...
            AgeRestriction ageRestriction
                    = AgeRestriction.values()[Integer.parseInt(lineParams[4])];
    ...
    public Set<String> getAllAuthorsWithBookBefore() {
        List<Book> books =
                this.bookRepository.findAllByReleaseDateBefore(LocalDate.parse("1999-01-01"));
