...
public class RacerServiceImpl implements RacerService {
    ...
    private final static String RACERS_JSON_FILE_PATH = "C:\\Users\\martoraneca\\Downloads\\MostWanted-skeleton\\MostWanted\\src\\main\\resources\\files\\racers.json";
    ...
    public String exportRacingCars() {
        ...
        List<Racer> racers = this.racerRepository.findRacingCars();
        ...
        racers.forEach(racer -> {
            ...
            racer.getCars().forEach(car -> {
                exportResult.append("\t").append(String.format("%s %s %d",
