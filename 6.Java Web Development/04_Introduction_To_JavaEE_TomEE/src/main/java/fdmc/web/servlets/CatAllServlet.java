...
public class CatAllServlet extends HttpServlet {
    ...
    private final static String ALL_CATS_HTML_FILE_PATH = "D:\\Programming stuff\\IdeaUltimateProjects\\Java Web Development\\04_Introduction_To_JavaEE_TomEE\\src\\main\\resources\\views\\cat-all.html";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (req.getSession().getAttribute("cats") == null) {
            ...
            ((Map<String, Cat>) req.getSession()
                    ...
                    .values()
                    .forEach(cat -> {
                        aS.append(String.format("<a href=\"/cats/profile?catName=%s\">%s<a/><br />",
