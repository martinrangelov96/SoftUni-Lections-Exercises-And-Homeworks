...
public class Engine implements Runnable {
    private static final String COMMAND_PATH = "exercises.pr0304Barracks.core.commands.";
    ...
    private String interpredCommand(String[] data, String commandName) {
        ...
        } catch (ClassNotFoundException | NoSuchMethodException | InvocationTargetException | InstantiationException | IllegalAccessException | ExecutionControl.NotImplementedException e) {
            e.printStackTrace();
        }
