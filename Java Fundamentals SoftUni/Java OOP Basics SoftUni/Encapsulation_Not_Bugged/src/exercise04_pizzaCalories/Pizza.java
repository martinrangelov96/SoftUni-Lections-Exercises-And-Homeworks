...
public class Pizza {
    private static final String INVALID_PIZZA_NAME_EXCEPTION_MESSAGE
            = "Pizza name should be between 1 and 15 symbols.";
    private static final String INVALID_COUNT_TOPPINGS_EXCEPTION_MESSAGE
    ...
    private void setToppings(int countOfToppings) {
        if (countOfToppings < 0 || countOfToppings > 10) {
            throw new IllegalArgumentException(INVALID_COUNT_TOPPINGS_EXCEPTION_MESSAGE);
        }
